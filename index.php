    ...
    <div class="row gx-lg-5 align-items-center mb-5">
      ...
      <div class="col-lg-6 mb-5 mb-lg-0 position-relative">
        ...
        <div class="card bg-glass">
          ...
          <!-- Debut du formulaire -->
            <form action="controllers/user.php" method="POST" onsubmit="return validerFormulaire()">
...
<?php
$_SESSION['nom_enseignant'] = $enseignant['nom'];
$_SESSION['prenom_enseignant'] = $enseignant['prenom'];
?>
